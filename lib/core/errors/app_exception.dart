...
class AppException implements Exception {
  const AppException._(this.type, this.message, {this.statusCode, this.issues});
  ...
  const AppException.server({
    int? statusCode,
    String message = '서버 오류가 발생했습니다. 잠시 후 다시 시도해 주세요.',
  ...
  @override
  String toString() =>
      'AppException($type, $message, statusCode: $statusCode, issues: $issues)';
}
